                                    ...
                                    <table class="table table-vcenter js-dataTable-full-pagination">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <?php echo anchor('transaksi/add_cart_do/'.$b['id_barang'],'<button class="btn btn-sm btn-dark"><i class="fa fa-fw fa-cart-plus"></i></button>') ?>
                                                </td>
...
<div class="card mb-2">
  ...
  <table>
    <tr>
        ...
        <td><input type="text" name="kode" class="font-weight-bold" value="DO<?= time() ?>" style="width:110%; background: #e6e6e6; border:1px solid #e6e6e6;" required readonly></td>
    </tr>
    <tr>
        <td>Tanggal </td>
        <td class="pl-1 pr-1">: </td>
