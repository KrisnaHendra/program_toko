<div class="content">
                    ...
                    <div class="block">
                        <div class="block-header">
                            <h3 class="block-title">Data Pelanggan <small>Cahaya Titan</small></h3>
                            <a href="" class="btn btn-sm btn-info"><i class="fa fa-users mr-1"></i>Jumlah Pelanggan : <?= $this->db->count_all('pelanggan') ?></a>
                        </div>
