...
<html lang="en">
  ...
  <body>
    <h1 class="text-center" style="font-size:60px;"><a href="<?= base_url('telur') ?>">CAHAYA TITAN</a></h1>
    ...
    <table class="table table-bordered">
        ...
        <tr class="text-center">
            <td class=""><p style="font-size:35px;">Telur</p></td>
            <td><p style="font-size:35px;">Rp. <?= number_format($harga_telur) ?></p></td>
            <td><p style="font-size:35px;"><?= number_format($jumlah_telur) ?> KG</p></td>
            <td><p style="font-size:35px;">Rp. <?= number_format($harga_telur*$jumlah_telur) ?></p></td>
        </tr>
        <?php if($kurang_uang<1){?>
        <?php }else{?>
                <tr>
                    <td class="text-center" colspan="3" style="font-size:35px;">Kurang Uang</td>
                    <td class="text-center" style="font-size:35px;">Rp. <?= number_format($kurang_uang) ?></td>
                </tr>
        <?php }?>
        
        <tr class="text-right">
            <td colspan="4"><h1>Total : Rp. <?= number_format(($harga_telur*$jumlah_telur)+$kurang_uang) ?></h1></td>
        </tr>
    </table>
    <!-- <h5>==================================================================================</h5> -->
    <?php if($catatan==''){?>
