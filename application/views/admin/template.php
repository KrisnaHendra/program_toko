...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="<?= base_url('assets/admin/') ?>assets/js/plugins/sweetalert2/sweetalert2.min.css">
        <link rel="stylesheet" type="text/css" href="<?= base_url('assets/admin/dist/swal/') ?>dist/sweetalert.css">
    ...
    <body>
        ...
        <div id="page-container" class="sidebar-o sidebar-dark enable-page-overlay side-scroll page-header-fixed">
            ...
            <aside id="side-overlay" class="font-size-sm">
                ...
                <div class="content-header border-bottom">
                    ...
                    <a class="img-link mr-1" href="javascript:void(0)">
                        <img class="img-avatar img-avatar32" src="<?= base_url('assets/admin/') ?>assets/media/avatars/avatar10.jpg" alt="">
                    </a>
                    <!-- END User Avatar -->

                    <!-- User Info -->
                    <div class="ml-2">
                        <a class="link-fx text-dark font-w600" href="javascript:void(0)"><?= $data['nama']; ?></a>
                    </div>
                    <!-- END User Info -->
            ...
            -->
            <nav id="sidebar" aria-label="Main Navigation" style="background-color: ;">
                <!-- Side Header -->
                    ...
                    <div>
                        ...
                        <div class="dropdown d-inline-block ml-3">
                            ...
                            <div class="dropdown-menu dropdown-menu-right font-size-sm smini-hide border-0" aria-labelledby="sidebar-themes-dropdown">
                                ...
                                <a class="dropdown-item d-flex align-items-center justify-content-between" data-toggle="theme" data-theme="<?= base_url('assets/admin/') ?>assets/css/themes/amethyst.min.css" href="#">
                                    <span>Amethyst</span>
                                    <i class="fa fa-circle text-amethyst"></i>
                                </a>
                                <a class="dropdown-item d-flex align-items-center justify-content-between" data-toggle="theme" data-theme="<?= base_url('assets/admin/') ?>assets/css/themes/city.min.css" href="#">
                                    <span>City</span>
                                    <i class="fa fa-circle text-city"></i>
                                </a>
                                <a class="dropdown-item d-flex align-items-center justify-content-between" data-toggle="theme" data-theme="<?= base_url('assets/admin/') ?>assets/css/themes/flat.min.css" href="#">
                                    <span>Flat</span>
                                    <i class="fa fa-circle text-flat"></i>
                                </a>
                                <a class="dropdown-item d-flex align-items-center justify-content-between" data-toggle="theme" data-theme="<?= base_url('assets/admin/') ?>assets/css/themes/modern.min.css" href="#">
                                    <span>Modern</span>
                                    <i class="fa fa-circle text-modern"></i>
                                </a>
                                <a class="dropdown-item d-flex align-items-center justify-content-between" data-toggle="theme" data-theme="<?= base_url('assets/admin/') ?>assets/css/themes/smooth.min.css" href="#">
                                    <span>Smooth</span>
                ...
                <div class="content-side content-side-full">
                    <ul class="nav-main">
                    <li class="nav-main-heading">Dashboard Admin</li>
                        ...
                        <li class="nav-main-item">
                            <a class="nav-main-link" href="<?= base_url('transaksi/history') ?>">
                                <i class="nav-main-link-icon si si-control-rewind"></i>
                                <span class="nav-main-link-name">History Transaksi</span>
                            </a>
                        </li>
                        <!-- <li class="nav-main-item">
                            <a class="nav-main-link" href="<?= base_url('telur') ?>">
                                <i class="nav-main-link-icon si si-briefcase"></i>
                                <span class="nav-main-link-name">Kasir Telur</span>
                            </a>
                        </li> -->
                        <li class="nav-main-item">
                            <a class="nav-main-link" href="<?= base_url('admin/note') ?>">
                        ...
                        <li class="nav-main-item">
                            <a class="nav-main-link" href="<?= base_url('ternak/transaksi') ?>">
                                <i class="nav-main-link-icon si si-basket-loaded"></i>
                                <span class="nav-main-link-name">Transaksi Ternak</span>
                            </a>
                        </li>
                        <li class="nav-main-item">
                            <a class="nav-main-link" href="<?= base_url('ternak/history_ternak') ?>">
                                <i class="nav-main-link-icon si si-basket-loaded"></i>
                                <span class="nav-main-link-name">History Ternak</span>
                            </a>
                        </li> -->
                        <!-- <li class="nav-main-item">
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <div class="dropdown d-inline-block ml-2">
                            <button type="button" class="btn btn-sm btn-dual" id="page-header-user-dropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <img class="rounded" src="<?= base_url('assets/admin/') ?>assets/media/avatars/avatar10.jpg" alt="Header Avatar" style="width: 18px;">
                                <span class="d-none d-sm-inline-block ml-1"><?= $data['nama'] ?></span>
                                <i class="fa fa-fw fa-angle-down d-none d-sm-inline-block"></i>
                            </button>
                            <div class="dropdown-menu dropdown-menu-right p-0 border-0 font-size-sm" aria-labelledby="page-header-user-dropdown">
                                <div class="p-3 text-center bg-primary">
                                    <img class="img-avatar img-avatar48 img-avatar-thumb" src="<?= base_url('assets/admin/') ?>assets/media/avatars/avatar10.jpg" alt="">
                                </div>
                                <div class="p-2">
        ...
        <script src="<?= base_url('assets/admin/') ?>assets/js/plugins/jquery-bootstrap-wizard/bs4/jquery.bootstrap.wizard.min.js"></script>
        <script src="<?= base_url('assets/admin/') ?>assets/js/plugins/jquery-validation/jquery.validate.min.js"></script>
        <script src="<?= base_url('assets/admin/') ?>assets/js/plugins/jquery-validation/additional-methods.js"></script>
        <script src="<?= base_url('assets/admin/') ?>assets/js/plugins/es6-promise/es6-promise.auto.min.js"></script>
        <script src="<?= base_url('assets/admin/') ?>assets/js/plugins/sweetalert2/sweetalert2.min.js"></script>
