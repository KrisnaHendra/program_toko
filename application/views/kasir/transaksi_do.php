...
<div class="block" style="background-color: #f0f0f0;">
                                ...
                                <div class="block-content">
                                    <table class="table table-vcenter js-dataTable-full-pagination">
                                        <thead>
                                            <tr class="bg-dark" style="background-color: #78acff; color:white;">
                                        ...
                                        <?php $no=1; foreach($barang as $b): ?>
                                            <tr>
                                                ...
                                                <?php echo anchor('kasir/add_cart_do/'.$b['id_barang'],'<button class="btn btn-dark"><i class="fa fa-fw fa-cart-plus"></i></button>') ?>
                                                </td>
...
<table class="table table-vcenter">
    ...
    <div class="row">
    <div class="col-md-1">
    <a href="<?= base_url('kasir/hapus_do'); ?>" class="btn btn-sm btn-warning mb-2 mr-2"><i class="fa fa-fw fa-trash-alt" style="color:white;"></i></a>
    </div>
    <div class="col-md-1">
    ...
    <?php foreach($this->cart->contents() as $items): ?>
        ...
        <td>
        <a href="<?= base_url('kasir/hapus_cart_do/') ?><?= $items['rowid'] ?>" class="btn btn-sm btn-danger"><i class="fa fa-fw fa-trash"></i> </a></td>
        </tr>
    <?php endforeach; ?>
